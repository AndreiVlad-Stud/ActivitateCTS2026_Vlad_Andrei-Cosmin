...
public class FisaDiagnoza extends Fisa{
    public FisaDiagnoza(String numeClient, float costEstimativ, List<String> operatiuni) {
    ...
    public void afiseazaDetalii() {
        ...
        builder.append("Detalii Fisa Diagnoza: ");
        builder.append("\n");
