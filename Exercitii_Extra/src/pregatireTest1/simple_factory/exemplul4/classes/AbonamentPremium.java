package pregatireTest1.simple_factory.exemplul4.classes;

import java.util.List;

public class AbonamentPremium extends Abonament{
    public AbonamentPremium(String numeAbonat, float pretBaza, List<String> beneficiiIncluse) {
